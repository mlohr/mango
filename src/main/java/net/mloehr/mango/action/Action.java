...
public class Action {
    ...
    public Action eval(String script, Result result) {
        tasks.add(Task.builder().id(getTaskName()).action(name).xpath("")
                .text(script).result(result).build());
        return this;
    }
     ...
     */
    public Action getAttribute(String xpath, String attribute,
            StringBuilder data) {
        tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath)
                .text(attribute).data(data).build());
        return this;
    }
    ...
    public Action slide(String xpath, int xCoordinate, int yCoordinate) {
        tasks.add(Task
                ...
                .action(name)
                .xpath(xpath)
                .text(String.valueOf(xCoordinate) + ","
                        + String.valueOf(yCoordinate)).build());
        return this;
    }
