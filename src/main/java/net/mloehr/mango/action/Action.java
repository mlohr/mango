...
public class Action {
	...
	public Action type(String xpath, String text) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text(text).build());
		return this;
	}
	...
	public Action check(String xpath) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text("check").build());
		return this;
	}
	...
	public Action clear(String xpath) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).build());
		return this;
	}
	...
	public Action uncheck(String xpath) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text("uncheck")
				.build());
		return this;
	}
	...
	public Action isChecked(String xpath, Result result) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).result(result).build());
		return this;
	}
	...
	/**
	 * clicks on the one web-element identified by 'xpath', when an array can be
	 * selected and the web-element is identified by 'index' -> index of 0
	 * clicks on the first element. -> index of 1 clicks on the second element,
	 * etc.. Negative values start from last element: -> index of -1 clicks on
	 * the last element. -> index of -2 clicks on the second-last element, etc..
	 */
	public Action click(String xpath, int index) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath)
				.text(String.valueOf(index)).build());
		return this;
	}
	...
	public Action eval(String script, Result result) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath("").text(script)
				.result(result).build());
		return this;
	}
	...
	public Action execute(String script) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath("").text(script).build());
		return this;
	}
	...
	public Action executeOnElement(String xpath, String script) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text(script).build());
		return this;
	}
	...
	public Action select(String xpath, String item) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text(item).build());
		return this;
	}
	...
	public Action testVisibility(String xpath, Object visible) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).data(visible).build());
		return this;
	}

	/**
	 * maps the text into 'data', using the {@link Mapper}, of web-element
	 * identified by 'xpath'
	 */
	public Action mapText(String xpath, Object data, Mapper mapper) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).data(data)
				.mapper(mapper).build());
		return this;
	}
	...
	public Action getAttribute(String xpath, String attribute, StringBuilder data) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text(attribute)
				.data(data).build());
		return this;
	}
	...
	public Action slide(String xpath, int xCoordinate, int yCoordinate) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath)
				.text(String.valueOf(xCoordinate) + "," + String.valueOf(yCoordinate)).build());
		return this;
	}

	/**
	 * select menu 'item' where 'xpath' opens the menu using hovering
	 */
	public Action selectMenuItem(String xpath, String item) {
		tasks.add(Task.builder().id(getTaskName()).action(name).xpath(xpath).text(item).build());
		return this;
	}
